...
for i in range(1, 4):
    for j in range(0, 5):
        stone_arch(100 * i,  40 * j, 0, 10 + 10 * i, 90, 3.8, 5 - 0.4 * j, 28, keystone=1.6, pentagons=(j % 2 == 0), bevel=False)
        stone_arch(100 * i, 40 * j + 20, 0, 10 + 10 * i, 90, 3.8, 5 - 0.4 * j, 36, keystone=1.6, pentagons=(j % 2 == 0), bevel=False)
